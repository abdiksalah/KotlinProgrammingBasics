...
fun capture(f: () -> Unit): CapturedException =
    try {
        ...
        CapturedException(
            null,
            "$ERROR_TAG Expected on exception"
        )
    } catch (e: Throwable) {
...
* Later commpares accumulated to expected:
